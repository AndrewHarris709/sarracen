...
def test_2d_cross_plot():
    ...
    fig, ax = plt.subplots()
    ax = sdf.render_2d_cross('P', ax=ax)
...
def test_3d_plot():
    ...
    fig, ax = plt.subplots()
    ax = sdf.render_3d('P', int_samples=10000, x_pixels=300, ax=ax)
...
def test_3d_cross_plot():
    ...
    fig, ax = plt.subplots()
    ax = sdf.render_3d_cross('P', x_pixels=489, ax=ax)
